...
from face_recognition_model import FaceRecognizer, FaceRecognizerH5
...
def recognize_face():
    ...
    recognizer = FaceRecognizerH5('/home/sandeshk/Documents/MyGitHubArch/Real-Time-Face-Recognition/src/models/weights/face-rec_Google.h5') 
